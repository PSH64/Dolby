...
import kr.ac.shingu.dolby.util.helper.DisplayRotationHelper
import kr.ac.shingu.dolby.util.helper.TrackingStateHelper
import kr.ac.shingu.dolby.util.render.*
import kr.ac.shingu.dolby.util.render.arcore.BackgroundRenderer
...
class HelloGeoRenderer(val activity: HelloGeoActivity) :
    ...
    private val anchorList: MutableList<Anchor> = mutableListOf()
...
//    }
        ...
        activity.view.mapView?.createMarker(EARTH_MARKER_COLOR, latLng)
