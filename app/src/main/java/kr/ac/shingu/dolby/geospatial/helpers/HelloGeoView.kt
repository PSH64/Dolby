...
import kr.ac.shingu.dolby.util.helper.SnackbarHelper
...
class HelloGeoView(val activity: HelloGeoActivity) : DefaultLifecycleObserver {
  ...
  val statusTextView = root.findViewById<TextView>(R.id.statusText)
...
//        cameraGeospatialPose.horizontalAccuracy,
        statusTextView.text=poseText
//        statusTextView.text = activity.resources.getString(R.string.earth_state,
